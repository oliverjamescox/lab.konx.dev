  ...
  <div class="text-grey leading-relaxed container mx-auto bg-white h-full">
    ...
    <div class="p-6 md:p-12 lg:py-12 lg:px-20">
      ...
      export default {
        ...
        <p class="mb-4">
          A component utilising a vuex store for the companyInformation object outputting the data made available globally by vuex.
        </p>
        <company-info />
      </div>
      <!-- Getters -->
      ...
      export default {
        ...
        <p class="mb-4">
          The original state object exists as it did and hasn't been changed or mutated, the getter has taken the available data and performed a function, in this example for something visual just adding some asterix's.
        </p>
        <company-info type="getters" />
      </div>
      <!-- Mutations -->
      <div class="mb-8">
        <h2 class="text-2xl text-black font-bold mb-4">
      ...
      <div class="mb-8">
        ...
        <p class="mb-4">
          This example outlines the steps to add to an action, the component itself has both seperate functions showcasing mutations / actions for reference.
        </p>
      ...
      <div class="mb-8">
        ...
        <p class="mb-4">
          Vuex uses a single state tree whereby all state is contained within one object, as the project grows the store could become bloated. Modules allow state, mutations and getters to be contained within their own module.
        </p>
        <div>
          <pre v-highlightjs>
                  <code class="javascript">
