  ...
  <div class="font-display text-sm mb-2">
    <div class="nav-block">
        ...
        <ul class="text-center text-white" :class="isExpanded ? 'visible' : 'hidden'">
          <li class="nav-block__child py-4 px-2 cursor-pointer transition duration-200 hover:bg-grey-light hover:text-grey"><router-link to="/basics/overview">Overview</router-link></li>
